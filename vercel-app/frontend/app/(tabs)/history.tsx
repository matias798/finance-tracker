...
const styles = StyleSheet.create({
  ...
  statsRow: { flexDirection: 'row', padding: 20, paddingTop: 10, gap: 10 },
  statCard: { flex: 1, backgroundColor: '#1a1a2e', padding: 16, borderRadius: 12, alignItems: 'center' },
  statValue: { color: '#fff', fontSize: 24, fontWeight: 'bold', marginTop: 8 },
  statLabel: { color: '#888', fontSize: 12, marginTop: 4 },
  totalCard: { backgroundColor: '#1a1a2e', marginHorizontal: 20, marginBottom: 10, padding: 20, borderRadius: 12, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  totalLabel: { color: '#888', fontSize: 16 },
  totalAmount: { color: '#6366f1', fontSize: 24, fontWeight: 'bold' },
  listContent: { padding: 20, paddingTop: 10 },
  itemCard: { backgroundColor: '#1a1a2e', borderRadius: 12, padding: 16, marginBottom: 12 },
  itemHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 12 },
  typeTag: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: 'rgba(255,255,255,0.05)', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6 },
  typeText: { fontSize: 12, fontWeight: '600' },
  dividedTag: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  dividedText: { color: '#10b981', fontSize: 12, fontWeight: '600' },
  itemBody: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' },
  itemInfo: { flex: 1 },
  itemName: { color: '#fff', fontSize: 18, fontWeight: '600' },
  itemDate: { color: '#666', fontSize: 12, marginTop: 4 },
